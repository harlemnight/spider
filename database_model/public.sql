...
CREATE TABLE "public"."t_china_security_market" (
  ...
  "market_jqdata" varchar(255) COLLATE "pg_catalog"."default"
)
;
...
COMMENT ON COLUMN "public"."t_china_security_market"."market_jqdata" IS '市场代码聚宽';
...
-- ----------------------------
-- Table structure for t_china_stock_hsgt_mx
-- ----------------------------
DROP TABLE IF EXISTS "public"."t_china_stock_hsgt_mx";
CREATE TABLE "public"."t_china_stock_hsgt_mx" (
  "symbol" varchar(255) COLLATE "pg_catalog"."default",
  "symbol_name" varchar(255) COLLATE "pg_catalog"."default",
  "rq" date,
  "participantcode" varchar(255) COLLATE "pg_catalog"."default",
  "participantname" varchar(255) COLLATE "pg_catalog"."default",
  ...
  "shareholdsumchg" varchar(255) COLLATE "pg_catalog"."default",
  "zb" varchar(255) COLLATE "pg_catalog"."default",
  "zzb" varchar(255) COLLATE "pg_catalog"."default"
)
;
COMMENT ON COLUMN "public"."t_china_stock_hsgt_mx"."participantcode" IS '机构代码';
COMMENT ON COLUMN "public"."t_china_stock_hsgt_mx"."participantname" IS '机构名称';
COMMENT ON COLUMN "public"."t_china_stock_hsgt_mx"."shareholdsum" IS '持股数量（股）';
COMMENT ON COLUMN "public"."t_china_stock_hsgt_mx"."sharesrate" IS '持股数量占A股百分比%';
COMMENT ON COLUMN "public"."t_china_stock_hsgt_mx"."closeprice" IS '收盘价';
COMMENT ON COLUMN "public"."t_china_stock_hsgt_mx"."zdf" IS '涨跌幅%';
COMMENT ON COLUMN "public"."t_china_stock_hsgt_mx"."shareholdprice" IS '持股市值（元）';
COMMENT ON COLUMN "public"."t_china_stock_hsgt_mx"."shareholdpriceone" IS '持股市值变化1日（元）';
COMMENT ON COLUMN "public"."t_china_stock_hsgt_mx"."shareholdpricefive" IS '持股市值变化5日（元）';
COMMENT ON COLUMN "public"."t_china_stock_hsgt_mx"."shareholdpriceten" IS '持股市值变化10日（元）';
COMMENT ON COLUMN "public"."t_china_stock_hsgt_mx"."market" IS '市场代码';
COMMENT ON COLUMN "public"."t_china_stock_hsgt_mx"."shareholdsumchg" IS '持股变动（股）';

-- ----------------------------
-- Table structure for t_china_stock_hsgt_tj
-- ----------------------------
DROP TABLE IF EXISTS "public"."t_china_stock_hsgt_tj";
CREATE TABLE "public"."t_china_stock_hsgt_tj" (
  "symbol" varchar(255) COLLATE "pg_catalog"."default",
  "symbol_name" varchar(255) COLLATE "pg_catalog"."default",
  "rq" date,
  "shareholdsum" varchar(255) COLLATE "pg_catalog"."default",
...
;
COMMENT ON COLUMN "public"."t_china_stock_hsgt_tj"."shareholdsum" IS '持股数量（股）';
COMMENT ON COLUMN "public"."t_china_stock_hsgt_tj"."sharesrate" IS '持股数量占A股百分比%';
COMMENT ON COLUMN "public"."t_china_stock_hsgt_tj"."closeprice" IS '收盘价';
COMMENT ON COLUMN "public"."t_china_stock_hsgt_tj"."zdf" IS '涨跌幅';
COMMENT ON COLUMN "public"."t_china_stock_hsgt_tj"."shareholdprice" IS '持股市值（元）';
COMMENT ON COLUMN "public"."t_china_stock_hsgt_tj"."shareholdpriceone" IS '持股市值变化1日（元）';
COMMENT ON COLUMN "public"."t_china_stock_hsgt_tj"."shareholdpricefive" IS '持股市值变化5日（元）';
COMMENT ON COLUMN "public"."t_china_stock_hsgt_tj"."shareholdpriceten" IS '持股市值变化10日（元）';
COMMENT ON COLUMN "public"."t_china_stock_hsgt_tj"."market" IS '市场代码';
COMMENT ON COLUMN "public"."t_china_stock_hsgt_tj"."shareholdsumchg" IS '持股变动（股）';
...
-- ----------------------------
-- Table structure for t_china_stock_rzrq
-- ----------------------------
DROP TABLE IF EXISTS "public"."t_china_stock_rzrq";
CREATE TABLE "public"."t_china_stock_rzrq" (
  "symbol" varchar(255) COLLATE "pg_catalog"."default",
  "symbol_name" varchar(255) COLLATE "pg_catalog"."default",
  "rq" date,
  "rzye" varchar(255) COLLATE "pg_catalog"."default",
  "rqyl" varchar(255) COLLATE "pg_catalog"."default",
  "rzrqye" varchar(255) COLLATE "pg_catalog"."default",
  "rqye" varchar(255) COLLATE "pg_catalog"."default",
  "rqmcl" varchar(255) COLLATE "pg_catalog"."default",
  "rzrqyecz" varchar(255) COLLATE "pg_catalog"."default",
  "rzmre" varchar(255) COLLATE "pg_catalog"."default",
  "sz" varchar(255) COLLATE "pg_catalog"."default",
  "rzyezb" varchar(255) COLLATE "pg_catalog"."default",
  "rzche" varchar(255) COLLATE "pg_catalog"."default",
  "rzjme" varchar(255) COLLATE "pg_catalog"."default",
  "rqchl" varchar(255) COLLATE "pg_catalog"."default",
  "rqjmg" varchar(255) COLLATE "pg_catalog"."default",
  "spj" varchar(255) COLLATE "pg_catalog"."default",
  "zdf" varchar(255) COLLATE "pg_catalog"."default"
)
;
COMMENT ON COLUMN "public"."t_china_stock_rzrq"."rzye" IS '融资余额';
COMMENT ON COLUMN "public"."t_china_stock_rzrq"."rqyl" IS '融券余量';
COMMENT ON COLUMN "public"."t_china_stock_rzrq"."rzrqye" IS '融资融券余额';
COMMENT ON COLUMN "public"."t_china_stock_rzrq"."rqye" IS '融券余额';
COMMENT ON COLUMN "public"."t_china_stock_rzrq"."rqmcl" IS '融券卖出量';
COMMENT ON COLUMN "public"."t_china_stock_rzrq"."rzrqyecz" IS '融资融券余额差值';
COMMENT ON COLUMN "public"."t_china_stock_rzrq"."rzmre" IS '融资买入额';
COMMENT ON COLUMN "public"."t_china_stock_rzrq"."sz" IS '市值';
COMMENT ON COLUMN "public"."t_china_stock_rzrq"."rzyezb" IS '融资余额占流通市值比';
COMMENT ON COLUMN "public"."t_china_stock_rzrq"."rzche" IS '融资偿还额';
COMMENT ON COLUMN "public"."t_china_stock_rzrq"."rzjme" IS '融资净买入';
COMMENT ON COLUMN "public"."t_china_stock_rzrq"."rqchl" IS '融券偿还量';
COMMENT ON COLUMN "public"."t_china_stock_rzrq"."rqjmg" IS '融券净卖出';
COMMENT ON COLUMN "public"."t_china_stock_rzrq"."spj" IS '收盘价';
COMMENT ON COLUMN "public"."t_china_stock_rzrq"."zdf" IS '涨跌幅';
...
-- ----------------------------
-- Table structure for t_jqdata_market
-- ----------------------------
DROP TABLE IF EXISTS "public"."t_jqdata_market";
CREATE TABLE "public"."t_jqdata_market" (
  "market_name" varchar(255) COLLATE "pg_catalog"."default",
...
-- ----------------------------
-- Table structure for t_jqdata_swhy
-- ----------------------------
DROP TABLE IF EXISTS "public"."t_jqdata_swhy";
CREATE TABLE "public"."t_jqdata_swhy" (
  "swhy_dm" varchar(255) COLLATE "pg_catalog"."default",
  "swhymc" varchar(255) COLLATE "pg_catalog"."default",
  "swhylevel" varchar(255) COLLATE "pg_catalog"."default"
)
;

-- ----------------------------
-- Table structure for t_jqdata_swhy_dzb
-- ----------------------------
DROP TABLE IF EXISTS "public"."t_jqdata_swhy_dzb";
CREATE TABLE "public"."t_jqdata_swhy_dzb" (
  "swhy_dm" varchar(255) COLLATE "pg_catalog"."default",
  "symbol" varchar(255) COLLATE "pg_catalog"."default"
)
;
